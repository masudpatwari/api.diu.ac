...
<p style="margin-top: 0.1in;">To the best of my knowledge {{ $profile['name'] }} is not involved or working with any organization or company in Bangladesh. So far as I know {{ ($profile['sex'] == 'M') ? 'he' : 'she' }} is not involved in any criminal activity. {{ ($profile['sex'] == 'M') ? 'He' : 'She' }} is a full time regular student.</p>
