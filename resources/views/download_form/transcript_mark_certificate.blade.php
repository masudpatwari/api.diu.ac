...
<head>
    ...
    <title>Transcript / Mark Certificate</title>
    <style>
        table {
    ...
    <tr>
        ...
        <th class="bt-none bb-none">
            <img src="{{ storage_path('assets/logo.png') }}" alt="Dhaka International University"
                 style="width: 100px;padding: 0 2px;">
        </th>
...
Banani, Dhaka-1213, Bangladesh</span>
    ...
    <tr>
        ...
        <th class="b-none">
            <span style="font-size: 23px">Transcript / Mark Certificate</span>
        </th>
    </tr>
...
<div style="width: 100%;" class="mt-5">
    ...
    <div style="float: left;width: 49%">
        <table>
            ...
            <tr>
                <td class="bb-none">Note: Student has no dues</td>
            </tr>
...
<table class="b-none mt-5">
    ...
    <tr class="b-none">
        ...
        <td colspan="6" class="br-none">Name of the Program: <b>{{ $decoded['department']['name'] ?? 'N/A' }}</b> ;
            <span style="padding-left: 5px;"></span>Duration of Course (Month):
            <b>{{ $student_provisional_transcript_marksheet_info['duration_in_month'] ?? 'N/A' }}</b></td>
        {{-- <td class="br-none">Duration of Course:................</td> --}}
    </tr>

    <tr class="b-none">
        <td class="br-none p-5">7.</td>
        <td colspan="4" class="br-none">Subject (Major if any) :
            <b>{{ $student_provisional_transcript_marksheet_info['batch_name_as_major'] ?? 'N/A' }}</b></td>
        <td colspan="2" class="br-none">Roll No: <b>{{ $decoded['roll_no'] ?? 'N/A' }}</b></td>
    </tr>

    <tr class="b-none">
        <td class="br-none p-5">8.</td>
        <td colspan="5" class="br-none">Registration No : <b>{{ $decoded['reg_code'] ?? 'N/A' }}</b> <span
                    style="padding-left: 15px;">Session: <b>{{ $decoded['batch']['sess'] ?? 'N/A' }}</b></span>
        </td>
    ...
    <tr class="b-none">
        ...
        <td colspan="2" class="br-none">Result: CGPA / Class :
            <b>{{ $student_provisional_transcript_marksheet_info['cgpa'] ?? 'N/A' }}</b></td>
    </tr>
    ...
    <tr class="b-none">
        ...
        <td colspan="6" class="br-none">Photocopy of S.S.C/H.S.C/Diploma and Graduation Certificate to be enclosed along
