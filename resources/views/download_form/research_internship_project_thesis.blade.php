...
<table>
    ...
    <tr class="">
        ...
        <th class="bt-none" style="width: 75%">
            <span style="font-size: 24px;text-transform: uppercase;">Dhaka International University</span>
        </th>
...
<table>
    <tr>
        ...
        <td style="width:2%">:</td>
        <td colspan="4"> <b>{{ $title ?? 'N/A' }}</b></td>
    </tr>

    <tr>
        <td>Name of the Organization</td>
        <td>:</td>
        <td colspan="4"> <b>{{ $organization ?? 'N/A' }}</b> </td>
    </tr>

    <tr>
        <td>Organization Address</td>
        <td>:</td>
        <td colspan="4"> <b>{{ $address ?? 'N/A' }}</b> </td>
    </tr>

    <tr>
        <td>Name of the Supervisor</td>
        <td>:</td>
        <td colspan="4"> <b>{{ $supervisor ?? 'N/A' }}</b> </td>
    </tr>

    <tr>
        <td>Name of the Co-supervisor (if any)</td>
        <td>:</td>
        <td colspan="4"> <b>{{ $co_supervisor ?? 'N/A' }}</b> </td>
    </tr>
</table>
...
<table>
    <tr>
        <td class="w-50 py-10 bb-none">Receipt No .................................... Date: ...............................</td>
        <td rowspan="2" class="bt-none br-none bb-none"></td>
    </tr>

    <tr>
        <td class="py-10 bb-none">Received TK. ...........................................................................</td>
    </tr>

    <tr>
        <td class="py-10 bb-none">(.............................................................................................)</td>
