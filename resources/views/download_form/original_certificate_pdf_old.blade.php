...
<body>
        ...
        <tr>
            <td class="b-none" style="width: 55%">
                <table style="border: 3px solid">
                    <tr>
                        <td class="py-10 b-none">Receipt No ......................... Date:
                            ...............................
                        </td>
                    ...
                    <tr>
                        <td class="py-10 b-none">(Taka.
                            .................................................... thousand only)
                        </td>
                    </tr>
                    <tr>
                        <td class="tr b-none" style="padding-top: 25px; "><span
    ...
    \SimpleSoftwareIO\QrCode\Facades\QrCode::format('png')->merge($url, 0.3, true)->size(150)->errorCorrection('H')->generate($details),
) !!} ">
                @endif
            </td>
        </tr>
    ...
    <table class="b-none mt-1">
        <tr>
            <th class="tc" style="font-size: 14px!important;">Name of the Program/Department:</th>
        </tr>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="width: 25%">{{ $student->shift->name ?? 'N/A' }}</td>
