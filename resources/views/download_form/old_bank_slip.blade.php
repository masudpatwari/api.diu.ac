...
<div style="width: 100%">
    ...
    <div style="width: 25%;border-right: 1px dotted #000;float: left;">
        ...
        <table class="b-none">
            <tr>
                <td colspan="2" class="bb-none br-none" style="padding-left: 13px">Receipt No. <b>
            ...
            <tr>
                <th class='f-12 bt-none' colspan="3">Export Import Bank of Bangladesh Limited</th>
            </tr>
        </table>
        ...
        <div style="width: 299px;margin: 0 auto;">
            ...
            <table class="mt-1 b-none">
                <tr>
                    <td class="tc f-12 bb-none p-0">House #49,Road #11.Block # H,Banani,Dhaka.</td>
                </tr>
                <tr>
                    <td class="tc f-12 bb-none p-0"><b>Banani Branch</b></td>
                </tr>
                <tr>
                    <td class="tc f-12 bb-none p-0">MSND Account No.06113100002042</td>
                </tr>
            ...
            <table class="mt-5 b-none">
                ...
                <tr>
                    <td colspan="2" class="bb-none bt-none">Department: <b>{{ $student->department->name ?? '' }}</b> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>Semester: <b>{{ $student->roll_no ?? '' }}</b></td>
                </tr>
            </table>
            ...
            <table class="mt-8">
                ...
                <tr>
                    <td class="tc bb-none">1.</td>
                    <td class="bb-none">Registration Fee</td>
                    <td class="bb-none"></td>
                </tr>
                <tr>
                    <td class="tc bb-none">2.</td>
                    <td class="bb-none">Admission Fee</td>
                    <td class="bb-none"></td>
                </tr>
                <tr>
                    <td class="tc bb-none">3.</td>
                    <td class="bb-none">Tuition Fee</td>
                    <td class="bb-none"></td>
                </tr>

                <tr>
                    <td class="tc bb-none">4.</td>
                    <td class="bb-none">Examination Fee</td>
                    <td class="bb-none"></td>
                </tr>
                <tr>
                    <td class="tc bb-none">5.</td>
                    <td class="bb-none">Improvement Fee</td>
                    <td class="bb-none"></td>
                </tr>
                <tr>
                    <td class="tc bb-none">6.</td>
                    <td class="bb-none">Marks Sheet Fee</td>
                    <td class="bb-none"></td>
                </tr>
                <tr>
                    <td class="tc bb-none">7.</td>
                    <td class="bb-none">Provisional Certificate Fee</td>
                    <td class="bb-none"></td>
                </tr>
                <tr>
                    <td class="tc bb-none">8.</td>
                    <td class="bb-none">Library fee</td>
                    <td class="bb-none"></td>
                </tr>
                <tr>
                    <td class="tc bb-none">9.</td>
                    <td class="bb-none">Fine/Late Fee</td>
                    <td class="bb-none"></td>
                </tr>
                <tr>
                    <td class="tc bb-none">10.</td>
                    <td class="bb-none">Others:</td>
                    <td class="bb-none"></td>
                </tr>
                <tr>
                    <td rowspan="3" class="bb-none"></td>
                    <td class="bb-none">(a)</td>
                    <td class="bb-none"></td>
                </tr>

                <tr>

                    <td class="bb-none">(b)</td>
                    <td class="bb-none"></td>
                </tr>

                <tr>

                    <td class="bb-none">(c)</td>
                    <td class="bb-none"></td>
                </tr>
    ...
    <div style="width: 25%;border-right: 1px dotted #000;float: left;">
        ...
        <table class="b-none">
            <tr>
                <td colspan="2" class="bb-none br-none" style="padding-left: 13px">Receipt No. <b>12345</b> </td>
        ...
        <div style="width: 299px;margin: 0 auto;">
            ...
            <table class="mt-15 b-none">
                <tr>
                    ...
                    <td class="bb-none br-none bt-none"><span style="border-top: 1px solid #000;">Bank's Officer</span></td>
                    <td class="bb-none"><span style="border-top: 1px solid #000;">Bank's Authorized Officer</span></td>
                </tr>
...
<div class="bank_two">
<!-- <img src="{{ storage_path('assets/exim.png') }}" alt="" width="200px"> -->
    <img src="{{ storage_path('assets/marcantile.png') }}" alt="" width="200px" style="opacity: .2">
</div>
