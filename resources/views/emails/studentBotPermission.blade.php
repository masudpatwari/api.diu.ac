            ...
            <div class="content">
                <table bgcolor="">
                    ...
                    <p style="max-width: 500px;margin: 0 auto;text-align: left;margin-top: 12px;">
                        <span>Subject: Seeking permission on IT Support Ticket Number  IST-S-{{ $supportTicket->id ?? '' }} </span>
                    </p>
                    ...
                    <p style="max-width: 500px;margin: 0 auto;text-align: left">
                        <span>I am {{ $employee->name ?? 'N/A' }}, {{ $employee->relDesignation->name ?? 'N/A' }} on
                            ...
                            by {{ $supportTicket->user->NAME ?? 'N/A' }}, {{ $supportTicket->user->REG_CODE ?? 'N/A' }} </span>
                    </p>
                            ...
                            <span>
                                <ul style="margin-left: 30px;">
                                    @foreach($supportTicket->supportTicketReplies as $row)
                                        ...
                                        <li>{{ $loop->iteration }}. {{ $row->reply_text ?? 'N/A' }}
                    ...
                    <p style="text-align: center; margin-top: 15px;">
                        ...
                        <a
                                href="{{ route('studentSupportTicketAction.getPermission',['token'=>$botData['yesToken']]) }}"
                                target="_blank"
                                title="Permitted"
                        ...
                        <a
                                href="{{ route('studentSupportTicketAction.getPermission',['token'=>$botData['noToken']]) }}"
                                target="_blank"
                                title="Not Permitted"
                    ...
                    <p style="max-width: 500px;margin: 0 auto;text-align: left;margin-top: 14px;">
                        ...
                        <span>{{ $employee->relDesignation->name ?? 'N/A' }}, {{ $employee->relDepartment->name ?? 'N/A' }}</span>
                        <br>
                        <span>{{ $employee->office_email ?? 'N/A' }}</span> <br>
                        <span>{{ $employee->office_phone_no ?? 'N/A' }}</span>
                    </p>
