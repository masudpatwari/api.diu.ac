                ...
                <div style="height: 180px">
                    <table class="mt-8">
                        ...
                        <tr>
                            <td>1</td>
                            <td>ENGLISH BOOK</td>
                            <td class="tc">{{ number_format($payable ?? '', 2) }}</td>
                        </tr>
                ...
                <table class="mt-8 b-none">
                    <tr>
                        <td class="bb-none" colspan="2">Received taka (In
                            words) <span
                                style="text-transform: capitalize"><b>{{ \App\classes\NumberToWord::numberToWord($payable) }}
                                    taka</b></span>
                            only.
                        </td>
                    </tr>
                ...
                <table class="mt-15 b-none">
                    ...
                    <tr>
                        <td class="br-none bt-none" style="padding-top: 65px" colspan="2">
                            <span style="border-top: 1px solid #000;">{{ $saler['name'] }}</span>
                            <p>{{ $saler['relDesignation']['name'] }}</p>
