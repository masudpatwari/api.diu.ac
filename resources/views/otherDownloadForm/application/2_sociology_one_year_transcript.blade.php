...
<table class="header_table">
    ...
    <tr>
        <td colspan="3"
            style="font-size: 20px;text-align: center;font-weight: bold;padding-bottom: 15px;">Master
    ...
    <tr>
        ...
        <td align="center" valign="middle" style="padding-top: 80px;font-size: 16px;font-weight: bold">
        ...
        <td align="right" width="2.2in">
            <table class="std_info" style="border: 1px solid #000000">
                <tr>
                    <td></td>
                    <td style="padding: 10.2px 0;text-align: left;">Issue No.</td>
                ...
                <tr>
                    <td></td>
                    <td style="padding: 10.2px 0;text-align: left;">Date</td>
                    <td style="padding: 8px 0">:</td>
                    <td></td>
                ...
                <tr>
                    <td></td>
                    <td style="padding: 10.2px 0;text-align: left;">Roll No.</td>
                    <td style="padding: 8px 0">:</td>
                    <td></td>
                    <td style="padding: 10.2px 0;text-align: left;"><b>{{ $student_info['roll_no'] }}</b></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="padding: 10.2px 0;text-align: left;">Regn. No.</td>
                    <td style="padding: 8px 0">:</td>
                    <td></td>
                    <td style="padding: 10.2px 0;text-align: left;"><b>{{ $student_info['reg_code'] }}</b></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="padding: 10.2px 0;text-align: left;">Session</td>
                    <td style="padding: 8px 0">:</td>
                    <td></td>
...
@if(!empty($transcript_data))
    <table class="transcript_table" style="margin-top: 20px">
        @foreach ($transcript_data as $transcript_data_key => $transcript_data_value)
            <tr>
                <th colspan="5" class="text-center text-uppercase" style="font-size: 17px;padding: 10px 0">
            ...
            <tr>
                @if($transcript_data_key == 0)
                    <th style="width: 13%">Course No.</th>
                    <th>Course Title</th>
