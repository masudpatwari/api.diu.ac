...
<table class="header_table">
    <tr>
        <td colspan="3"
            style="padding-bottom: 13px;font-size: 23px;text-transform: uppercase;letter-spacing: 2px;font-weight: bold;padding-left: 135px">
            Dhaka International University
        </td>
    </tr>

    <tr>
        <td colspan="3" style="padding-bottom: 15px;font-size: 21px;text-align: center;font-weight: bold;">Transcript of
            Academic Records
        </td>
    </tr>
    ...
    <tr>
        <td colspan="3"
            style="padding-bottom:5px;font-size: 20px;text-align: center;font-weight: bold;">LL.M. Examination
