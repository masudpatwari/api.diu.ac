...
<table class="header_table">
    ...
    <tr>
        <td colspan="3"
            style="font-size: 23px;text-align: center;font-weight: bold;padding-bottom: 15px;letter-spacing: 1px">M. A.
            in English Examination - {{ \Carbon\Carbon::parse(str_replace('/', '-', $student_provisional_transcript_marksheet_info['result_publish_date_of_last_semester']))->format('Y') }}</td>
    </tr>
    ...
    <tr>
        ...
        <td align="center" valign="middle" style="padding-top: 60px;font-size: 15px;font-weight: bold">
        ...
        <td align="right" width="2.2in">
            <table class="std_info" style="border: 1px solid #000000">
                <tr>
                    <td></td>
                    <td style="padding: 9.2px 0;text-align: left;">Issue No.</td>
                ...
                <tr>
                    <td></td>
                    <td style="padding: 9.2px 0;text-align: left;">Date</td>
                    <td style="padding: 8px 0">:</td>
                    <td></td>
                ...
                <tr>
                    <td></td>
                    <td style="padding: 9.2px 0;text-align: left;">Roll No.</td>
                    <td style="padding: 8px 0">:</td>
                    <td></td>
                    <td style="padding: 9.2px 0;text-align: left;"><b>{{ $student_info['roll_no'] }}</b></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="padding: 9.2px 0;text-align: left;">Regn. No.</td>
                    <td style="padding: 8px 0">:</td>
                    <td></td>
                    <td style="padding: 9.2px 0;text-align: left;"><b>{{ $student_info['reg_code'] }}</b></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="padding: 9.2px 0;text-align: left;">Session</td>
                    <td style="padding: 8px 0">:</td>
                    <td></td>
...
@if(!empty($transcript_data))
    <table class="transcript_table" style="margin-top: 10px">
        @foreach ($transcript_data as $transcript_data_key => $transcript_data_value)
            <tr>
                <th colspan="5" class="text-center text-uppercase" style="font-size: 14px;padding: 3px 0">
            ...
            <tr>
                @if($transcript_data_key == 0)
                    ...
                    <th style="width: 13%">Grade Earned</th>
            ...
            @if (is_array($transcript_data_value['allocated_courses']))
                @foreach($transcript_data_value['allocated_courses'] as $allocateSubject)
                    <tr>
                        ...
                        <td class="tc"><b>{{ $allocateSubject['credit'] }}</b></td>
...
@if(!empty($transcript_result))
    <table class="summary_table">
        ...
        <tr>
            <th style="text-align: left;border-left: 1px solid #FFFFFF;border-right: 1px solid #FFFFFF;border-bottom: 2px solid #FFFFFF;font-size: 14px;padding-top: 10px;padding-left: -1px">
                Result
                Published
                on {{ \Carbon\Carbon::parse($otherStudentForm->result_published_date)->format('d-m-Y') }}
            </th>
            <th style="text-align: center;border-left: 1px solid #FFFFFF;border-bottom: 1px solid #FFFFFF;border-right: 1px solid #FFFFFF;font-size: 14px;padding-top: 10px"
