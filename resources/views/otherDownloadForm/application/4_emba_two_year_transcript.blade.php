...
<table class="header_table">
    ...
    <tr>
        <td colspan="3"
            style="font-size: 20px;text-align: center;font-weight: bold;padding-bottom: 10px">Master of Business
...
@if(!empty($transcript_data))
    <table class="transcript_table" style="margin-top: 20px">
        @foreach ($transcript_data as $transcript_data_key => $transcript_data_value)
            <tr>
                <th colspan="5" class="text-center text-uppercase" style="font-size: 14px;padding: 5px 0">
