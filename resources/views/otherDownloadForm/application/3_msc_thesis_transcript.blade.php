...
<table class="header_table">
    <tr>
        <td colspan="3"
            style="padding-bottom: 21px;font-size: 26px;text-transform: uppercase;letter-spacing: 2px;font-weight: bold;padding-left: 135px">
            Dhaka International University
        </td>
    </tr>

    <tr>
        <td colspan="3" style="padding-bottom: 21px;font-size: 24px;text-align: center;font-weight: bold;">Transcript of
            Academic Records
        </td>
    </tr>
    ...
    <tr>
        <td colspan="3"
            style="font-size: 20px;text-align: center;font-weight:650;padding-bottom: 20px;font-weight: bold;">M.Sc. in
            Computer Science &
            Engineering
            Examination
...
@if(!empty($transcript_data))
    <table class="transcript_table" style="margin-top: 40px">
        ...
        <tr>
            ...
            <th style="width: 16%">Credit Hours</th>
            <th style="width: 16%">Grade Earned</th>
            <th style="width: 15%">Grade Point</th>
        </tr>
        <tr>
            <td class="tc" style="padding-bottom: 20px">CSE-501</td>
        ...
        <tr>
            <td class="tc" style="padding-bottom: 20px">CSE-502</td>
        ...
        <tr>
            <td class="tc" style="padding-bottom: 20px">CSE-504</td>
        ...
        <tr>
            <td class="tc" style="padding-bottom: 20px">CSE-529</td>
        ...
        <tr>
            <td class="tc" style="padding-bottom: 20px">CSE-519</td>
        ...
        <tr>
            <td class="tc" style="padding-bottom: 20px">CSE-524</td>
        ...
        <tr>
            <td class="tc" style="padding-bottom: 20px">CSE-532</td>
            <td>Thesis Work</td>
            @if(is_array($transcript_data[2]['allocated_courses']))
                <td class="tc">{{ \App\Libraries\Transcript::creditHour($transcript_data[2]['allocated_courses'],'CSE-532') }}</td>

                @if($transcript_data[2]['exempted'] == 0)

                    @if(!empty(\App\Libraries\Transcript::markCheck($transcript_data[2]['allocated_courses'],'CSE-532')))
                        <td class="tc">
                            <b>{{ \App\Libraries\Transcript::gradeEarned($transcript_data[2]['allocated_courses'],'CSE-532') }}</b>
                        </td>
                        <td class="tc">
                            <b>{{ \App\Libraries\Transcript::gradePoint($transcript_data[2]['allocated_courses'],'CSE-532') }}</b>
                        </td>
                    @else
                        <td colspan="2" style="text-align: center;font-weight: bold;">Incomplete</td>
                    @endif
...
@if(!empty($transcript_result))
    <table class="summary_table">
        <tr>
            <th style="text-align: left;border-right: 1px solid #FFFFFF;font-size: 16px">Total Credit Required
            ...
            @endif
            <th style="border-right: 1px solid #FFFFFF;font-size: 16px">Credit Earned
                : {{ $transcript_result['total_credit_earned'] }}</th>
            <th style="border-right: 1px solid #FFFFFF;font-size: 16px">Average Grade
                : {{ $transcript_result['grade_letter'] }}</th>
            <th style="text-align: right;font-size: 16px">CGPA
                : {{ sprintf('%0.2f', $transcript_result['cgpa']) }}</th>
        </tr>
        <tr>
            <th style="text-align: left;border-left: 1px solid #FFFFFF;border-right: 1px solid #FFFFFF;border-bottom: 2px solid #FFFFFF;font-size: 15px;padding-top: 20px">
                Result
                Published
                on {{ \Carbon\Carbon::parse($otherStudentForm->result_published_date)->format('d-m-Y') }}
            </th>
            <th style="text-align: center;border-left: 1px solid #FFFFFF;border-bottom: 1px solid #FFFFFF;border-right: 1px solid #FFFFFF;font-size: 15px;padding-top: 20px"
