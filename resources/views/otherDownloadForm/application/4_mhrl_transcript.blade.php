...
<table class="header_table">
    ...
    <tr>
        <td colspan="3" style="padding-bottom: 13px;font-size: 23px;text-align: center;font-weight: bold;">Transcript of
            Academic Records
        </td>
    </tr>
    ...
    <tr>
        <td colspan="3"
            style="font-size: 21px;text-align: center;font-weight: bold;padding-bottom: 10px;">Master of Human Rights
            Law Examination
    ...
    <tr>
        ...
        <td align="right" width="2.2in">
            <table class="std_info" style="border: 1px solid #000000">
                <tr>
                    <td></td>
                    <td style="padding: 8px 0;text-align: left;">Issue No.</td>
                ...
                <tr>
                    <td></td>
                    <td style="padding: 8px 0;text-align: left;">Roll No.</td>
                    <td style="padding: 8px 0">:</td>
                    <td></td>
                    <td style="padding: 8px 0;text-align: left;"><b>{{ $student_info['roll_no'] }}</b></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="padding: 8px 0;text-align: left;">Regn. No.</td>
                    <td style="padding: 8px 0">:</td>
                    <td></td>
                    <td style="padding: 8px 0;text-align: left;"><b>{{ $student_info['reg_code'] }}</b></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="padding: 8px 0;text-align: left;">Session</td>
                    <td style="padding: 8px 0">:</td>
                    <td></td>
...
@if(!empty($transcript_data))
    <table class="transcript_table" style="margin-top: 20px">
        @foreach ($transcript_data as $transcript_data_key => $transcript_data_value)
            <tr>
                <th colspan="5" class="text-center text-uppercase" style="font-size: 14px;padding: 10px 0">
            ...
            <tr>
                @if($transcript_data_key == 0)
                    ...
                    <th style="width: 14%">Grade Earned</th>
...
@if(!empty($transcript_result))
    <table class="summary_table">
        <tr>
            <th style="text-align: left;border-right: 1px solid #FFFFFF;font-size: 15px;padding: 5px">Total Credit
                Required
            ...
            @endif
            <th style="border-right: 1px solid #FFFFFF;font-size: 15px;padding: 5px">Credit Earned
                : {{ $transcript_result['total_credit_earned'] }}</th>
            <th style="border-right: 1px solid #FFFFFF;font-size: 15px;padding: 5px">Average Grade
                : {{ $transcript_result['grade_letter'] }}</th>
            <th style="text-align: right;font-size: 15px;padding: 5px">CGPA
        ...
        <tr>
            ...
            <th style="text-align: center;border-left: 1px solid #FFFFFF;border-bottom: 1px solid #FFFFFF;border-right: 1px solid #FFFFFF;font-size: 14px"
                colspan="3"></th>
        </tr>
    </table>
@endif
