...
<table class="b-none">
    ...
    <tr>
        <td rowspan="5" class="bt-none bb-none br-none">
            Form No : <b>{{ $otherStudentForm->id ?? 'N/A' }}</b> <br>
            <img src="{{ storage_path('assets/cecd.png') }}" alt="Dhaka International University"
                 style="width: 100px;padding:0 8px">
        </td>

        <th colspan="2" class="b-none" style="width: 80%">
...
<table style="margin-top: 70px;">
    ...
    <tr>
        <td class="tr br-none bb-none" style="font-size: 10px;">Signature of the Authorized Officer with official seal
        </td>
    </tr>
    <tr>
        <td class="tr" style="padding-top: 50px;">{{ $otherStudentForm->employee->name ?? 'N/A' }}
