<div style="overflow: hidden; margin-bottom: 0.05in;">
    <div style="border: 1px solid #000; width: 1.5in; height: 1.5in; text-align: center; float: left;">
        ...
        $qrCode = "https://api.diu.ac/images/admitCardQrCode/{$id}.png"
        @endphp
        @if(empty($url))
    ...
    <div style="text-align: center; width: 5.7in; float: left;">
        <div style="text-align: center; width: 5in; float: left;">
            ...
            <div style="width: 3in; float: left;margin-left: 45px">
                <img src="{{ storage_path('assets/admit_card.png') }}" alt="" style="width: 160px;">
        ...
        <div style="text-align: center; width: 100%; float: left;">
            <div style="text-align: center; width: 3.97in; float: left;">
                ...
                <img src="data:image/png;base64, {!! base64_encode(\SimpleSoftwareIO\QrCode\Facades\QrCode::format('png')
                        ->merge(storage_path('assets/white_logo.png'), 0.6, true)
...
<div style="overflow: hidden; margin-bottom: 0.1in; font-size: 11px;">
    ...
    <div style="width: 1.8in; float: left; text-transform: capitalize;"><strong>Semester Final Examinations - </strong>
    </div>
    ...
    @if(!empty($allocated_course))
        ...
        @foreach($allocated_course as $key => $course)
            <div style="float: left; width: 3.6in; margin: 5px 0;">
                ...
                <div style="width: 3.19in; float: left; border-bottom: 1px dotted #000;">
...
@endfor
        -->
<div style="overflow: hidden; margin: 5px 0;">
    <div style="width: 3.19in; float: left;"><strong>Starting Date of the Examinations
            : {!! $exam_start_date ?? '&nbsp;' !!}</strong></div>
...
<div style="text-align: center;margin-top: 10px">
    <p style="color: red">Computer Generated Admit Card Requires No Signature.</p>
</div>
