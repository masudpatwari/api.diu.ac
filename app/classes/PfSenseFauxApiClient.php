...
class PfSenseFauxApiClient
{
    ...
    public function __construct()
    {
        ...
        $this->uri = env('PFSENSE_FAUX_API_CLIENT_URI');
        $this->apiKey = env('PFSENSE_FAUX_API_CLIENT_APIKEY');
        $this->apiSecret = env('PFSENSE_FAUX_API_CLIENT_APISECRET');
