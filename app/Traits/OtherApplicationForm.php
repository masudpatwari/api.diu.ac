...
trait OtherApplicationForm
{
    public function scholarshipForm(int $student_id)
    {

        $studentInfoWithCompleteSemesterResult = $this->studentInfoWithCompleteSemesterResult($student_id);
        ...
        $view = view('otherDownloadForm/scholarship', compact('student', 'student_account_info_summary', 'last_payment'));
